...
import { addTask, getTasks, getTask, updateTask, deleteTask, toggleTask, getTaskCount } from '../src/task';
...
describe('Task Management', () => {
  ...
  describe('updateTask', () => {
    test('should update task name', async () => {
      ...
      const updatedTask = await updateTask({ id: task.id, name: 'Updated Name' });
